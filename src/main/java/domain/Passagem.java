...
public class Passagem implements Serializable {
    ...
    public Passagem(int idpassagem, int poltrona, Date datasaida, String horasaida, Cidade cidadeorigem, Cidade cidadedestino, double valorpassagem, Veiculo veiculo) {
